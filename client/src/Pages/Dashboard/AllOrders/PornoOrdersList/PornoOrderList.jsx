...
import { getPornoOrderList } from "../../../../Api/AllProductsRelatedApi/allProductsApi";
import PornoOrderCard from "./PornoOrderCard";

const PornoOrderList = () => {
     const [moreText,setMoreText] = useState(false);
        ...
        const {data:customerOrderData,isLoading,refetch} = useQuery({
            ...
            queryFn:async () => await getPornoOrderList() 
        })
    return <>
    <div>
    <div className="my-10">
                ...
                <table className="min-w-full bg-white border border-gray-300 shadow-md">
                    ...
                    <tbody>
                       {customerOrderData?.map((order) => (
                            <PornoOrderCard key={order._id} order={order} loading={isLoading} reFetch={refetch}/>
                        ))}
                    </tbody>
                </table>
            </div>
