...
import { getSingleFoodById } from "../../../Api/fastFoodRelatedApi/foodApi";
   ...
   <div className="my-14">
     ...
     <div className="flex flex-col items-center justify-center ">
       <div className="border p-4 shadow-xl w-full md:w-[40%] relative">
        <div className="absolute -top-10 left-[45%] rounded-full overflow-hidden bg-primary w-24 h-24 flex flex-col items-center justify-center">picture</div>
         <div className=" space-y-4">
           ...
           <p className="text-black font-medium text-2xl ">{detailsFood?.foodPrice}</p>
           <p>{detailsFood?.foodDescription}</p>
        ...
        <div className="mb-5">
            ...
            <input name="email" className="border-slate-300 border focus:outline-none bg-transparent px-4 py-2 rounded-lg text-[16px] w-full" type="number" placeholder='আপনার ইমেইল দিন---' required/>
            </div>
            </div>
            <div>
