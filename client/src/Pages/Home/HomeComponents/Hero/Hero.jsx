            ...
            <div className="hero-content text-center">
              <div className="md:w-[500px]">
                ...
                <div className="flex items-center justify-center gap-5 md:gap-8">
                  <div onClick={''} className="md:text-xl text-base p-[6px] rounded cursor-pointer bg-gradient-to-r from-primary to-green-800 text-neutral"><Link to={'/addDebts'}>পাওনাদার যুক্ত করুন</Link></div>
                  <div className="md:text-xl text-base p-[6px] rounded cursor-pointer bg-gradient-to-r from-green-800 to-primary text-neutral"><Link to={'/signUp'}>রেজিস্ট্রেশন করুন</Link></div>
                </div>
                </div>
              </div>
            </div>
