            ...
            <div className="hero-content text-center">
              <div className="md:w-[550px]">
                ...
                <div className="flex items-center justify-center gap-5 md:gap-8">
                  {
                    dbUser?.status === "admin" ? <><div onClick={''} className="md:text-xl text-base p-[6px] rounded cursor-pointer bg-gradient-to-r hover:bg-gradient-to-l  from-primary to-green-500 text-neutral"><Link to={'/dashboard/addDebts'}>পাওনাদার যুক্ত করুন</Link></div>  <div className="md:text-xl text-base p-[6px] rounded cursor-pointer bg-gradient-to-r hover:bg-gradient-to-l  from-green-500 to-primary text-neutral"><Link to={'/dashboard/showAlldebts'}>পাওনাদার দেখুন</Link></div></>:<>
                    {
